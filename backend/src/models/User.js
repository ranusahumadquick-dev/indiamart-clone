...
const userSchema = new mongoose.Schema(
  {
    ...
    // --- Account Freeze (seller can still log in / manage drafts, just can't
    //     publish products live — distinct from isActive which blocks login
    //     entirely, and from isVerified which is the one-time doc review) ---
    accountFrozen: { type: Boolean, default: false },
    accountFrozenReason: { type: String, trim: true },
    accountFrozenAt: { type: Date },
    ...
    companyVideo: { type: String, trim: true, default: "" },   // legacy single video (kept for migration)
    companyVideos: [{                                           // YouTube / Vimeo links
      _id: false,
      url:         { type: String, required: true, trim: true },
      title:       { type: String, trim: true, default: "" },
      description: { type: String, trim: true, default: "" },
    }],
    uploadedVideos: [{                                          // Cloudinary/local uploaded videos
      _id: false,
      url:   { type: String, required: true, trim: true },
      title: { type: String, trim: true, default: "" },
    }],
    virtualTourUrl: { type: String, trim: true, default: "" }, // 360° tour link
    ...
    galleryImages: [
      {
        ...
        category: {
          type: String,
          enum: ["office", "factory", "team", "warehouse", "showroom", "logo", "other"],
          default: "other",
        },
