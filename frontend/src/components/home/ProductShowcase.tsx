...
import { HiOutlineArrowRight, HiOutlineShieldCheck, HiOutlineMapPin, HiOutlineFire, HiOutlineArchiveBox } from "@/lib/icons";
      ...
      <div className="relative w-full aspect-square overflow-hidden bg-gray-50">
        {img ? (
          ...
          <div className="w-full h-full flex items-center justify-center text-gray-300 bg-gradient-to-br from-gray-50 to-gray-100">
            <HiOutlineArchiveBox className="w-10 h-10" />
          </div>
        )}
            ...
            : products.length > 0
              ...
              : (
                <div className="col-span-full text-center py-14 bg-white rounded-xl border border-gray-100">
                  <HiOutlineArchiveBox className="w-9 h-9 mx-auto mb-3 text-gray-300" />
