                  ...
                  return (
                    <div key={item._id} className="px-4 py-3.5 hover:bg-gray-50 transition">
                      <div className="flex items-start gap-3">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold flex-shrink-0 relative overflow-visible ${s.isVerified ? "bg-blue-600" : "bg-[var(--primary)]"} text-white`}>
                          {s.businessLogo
