...
const SERVICE_META: Record<string, { icon: string; gradient: string; bg: string }> = {
  Manufacturing: { icon: "⚙️", gradient: "from-blue-500 to-blue-700", bg: "bg-blue-50" },
  Logistics: { icon: "🚚", gradient: "from-emerald-500 to-emerald-700", bg: "bg-emerald-50" },
  "Quality Testing": { icon: "✅", gradient: "from-purple-500 to-purple-700", bg: "bg-purple-50" },
  Consulting: { icon: "💡", gradient: "from-amber-500 to-amber-700", bg: "bg-amber-50" },
  Design: { icon: "🎨", gradient: "from-pink-500 to-pink-700", bg: "bg-pink-50" },
  Marketing: { icon: "📱", gradient: "from-cyan-500 to-cyan-700", bg: "bg-cyan-50" },
};
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((service) => {
              const meta = SERVICE_META[service.category] || { icon: "📋", gradient: "from-gray-500 to-gray-700", bg: "bg-gray-50" };
