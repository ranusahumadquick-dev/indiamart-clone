...
import { HiStar, HiOutlineQuestionMarkCircle, HiOutlineSparkles } from "@/lib/icons";
...
function TestimonialCard({ t }: { t: typeof TESTIMONIALS[0] }) {
  return (
    <div className="w-[320px] sm:w-[360px] shrink-0 bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      ...
      {/* Savings Badge */}
      <div className={`inline-flex items-center gap-1 bg-gradient-to-r ${t.color} text-white text-[10px] font-bold px-2.5 py-1 rounded-full mb-4`}>
