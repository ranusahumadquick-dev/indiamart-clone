        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <p className="text-center text-[11px] text-gray-400 mt-4">
              ...
              <Link href="/terms" target="_blank" className="text-gray-500 hover:text-[var(--primary)] hover:underline">Terms of Service</Link>
              {" "}and{" "}
              <Link href="/privacy" target="_blank" className="text-gray-500 hover:text-[var(--primary)] hover:underline">Privacy Policy</Link>
            </p>
          </div>
        </div>
      </div>
