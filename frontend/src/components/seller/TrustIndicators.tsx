  ...
  const trustItems = [
    {
      icon: HiCheckBadge,
      label: 'GST Verified',
      verified: seller?.isGSTVerified,
      description: 'Tax Identification Verified',
    },
    {
    ...
    },
    {
      ...
      verified: seller?.isPhoneVerified,
    ...
    },
    {
      ...
      verified: seller?.isPremiumSeller,
      description: 'Premium Business Member',
    },
    {
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-green-50">
              This seller has completed {seller?.isGSTVerified ? 'multiple' : 'basic'} verifications and maintains high buyer satisfaction standards.
            </p>
          </div>
