...
interface Conversation {
  _id: string;
  participants: { _id: string; name: string; avatar?: string; role: string; companyName?: string; isTrusted?: boolean }[];
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold truncate flex items-center gap-1">
                  ...
                  {otherUser.isTrusted && <HiOutlineShieldCheck className="w-3.5 h-3.5 text-blue-200 flex-shrink-0" />}
                </p>
                {activeConv.product && (
