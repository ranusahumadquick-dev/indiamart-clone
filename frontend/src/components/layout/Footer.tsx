      ...
      <div className="bg-[#0d1428] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {[
              { icon: HiOutlineTrophy, title: "25+ Years", sub: "Of trust & reliability" },
              { icon: HiOutlineCheckCircle, title: "2M+ Verified", sub: "Suppliers on platform" },
              { icon: HiOutlineLockClosed, title: "100% Secure", sub: "Buyer protection" },
              { icon: HiOutlineBolt, title: "24/7 Support", sub: "Always here to help" },
            ].map((item, i) => (
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
            ...
            <div className="flex items-center gap-4">
              <span className="text-gray-700 inline-flex items-center gap-1">
                Made with <HiOutlineHeart className="w-3.5 h-3.5 text-red-500 fill-red-500" /> in India
              </span>
              <span>·</span>
