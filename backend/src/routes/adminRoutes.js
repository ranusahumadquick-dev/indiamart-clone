...
// All admin routes require authentication + admin role. Must be registered
// before any route below — Express only applies router.use() middleware to
// routes that come after it, so this was previously leaving the seed/variant
// routes below completely unauthenticated.
...
router.patch("/users/:id/freeze", freezeSeller);
